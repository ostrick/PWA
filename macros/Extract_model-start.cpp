...
void Multipole(Char_t* Mlp, Int_t SolLo=0, Int_t SolHi=0, Bool_t W=true, Bool_t SAVE=true, Double_t Lo=0.0, Double_t Hi=0.0, Double_t MASS_INITIAL=938.2720, Int_t D_WAVES=MODEL)
{
  Double_t MASS2_INITIAL = MASS_INITIAL*MASS_INITIAL;
